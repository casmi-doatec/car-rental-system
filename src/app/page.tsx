...
const testimonials = [
  { name: "田中 健太", country: "日本", rating: 5, text: "対応がとても丁寧で、車もピカピカでした。料金も明瞭で安心して利用できました。沖縄旅行にぜひおすすめです。", avatar: "田" },
  { name: "佐藤 美咲", country: "日本", rating: 5, text: "初めてのレンタカーでしたが、スタッフの方が丁寧に説明してくれて安心できました。車も新しくて快適でした。", avatar: "佐" },
  { name: "山田 太郎", country: "日本", rating: 4, text: "家族旅行で利用しました。チャイルドシートも無料で貸してもらえて助かりました。次回もお願いしたいです。", avatar: "山" },
